...
final class SimpleDslNativePlugin implements Plugin<Project> {
    void apply(Project project) {
        project.pluginManager.apply('io.github.qigao.simpledsl.module')
        SimpleDslCapabilitySupport.registerAndEnable(project, 'io.github.qigao.simpledsl.feature.native', BuiltinCapabilities.NATIVE)
    }
}
